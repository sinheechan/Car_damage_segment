...
# input : Scratch 이미지 => 서비스화 시 watcher 변수처리 필요
img_path = 'C:/sinheechan.github.io-master/Car_Scratch_MLops/samples/damage/0001061_sc-123724.jpg'

img  = cv2.imread(img_path)
img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB) # img > BGR > RGB
...
img_input = img / 255. 
img_input = img_input.transpose([2, 0, 1]) # Numpy 차원 순서 변환 : H(0), W(1), C(2) 
...
# 결과 이미지파일 대조 > 스크레치에 대한 인식이 정상 작동 check
